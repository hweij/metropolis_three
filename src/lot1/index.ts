...
import { createTexMatrix, Face } from '../geometry/geomat';
...
function addGroundLevel(scene: THREE.Scene) {
    ...
    const fgeo = new HPlaneGeometry([
        3.5,2.85, 9.45,2.85, 9.45,13.15, 1.85,13.15, 1.85, 5.85, 3.5, 5.85], [], [10.8, 15], Face.TOP, {pos: [0,0.4,0], depth: 0.2, uvmat: createTexMatrix([0,0,1,1], 0, false)});
